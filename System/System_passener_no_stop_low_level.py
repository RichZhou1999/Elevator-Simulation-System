        ...
        for i in range(1, max_floor + 1):
            ...
            for j in range(number):
                if i == 1 or i == 2:
                    ...
                    #                    destination_floor=0,
                    #                    start_time=self.current_simulation_time)
                    # temp_p.set_get_on_elevator_time(30*i + self.current_simulation_time)
                    # temp_p.set_arrival_time(30 * i + self.current_simulation_time)
                    # self.past_passengers.append(copy.copy(temp_p))
                else:
                    temp_p = Passenger(uuid.uuid4(),
                                       starting_floor=i,
                                       destination_floor=0,
